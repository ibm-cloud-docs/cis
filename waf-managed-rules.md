...
* **Sensitivity**: The [old sensitivity values](docs/cis?topic=cis-owasp-rule-set-for-waf) will be migrated to the following [Paranoia level (PL)](docs/cis?topic=cis-owasp-rule-set-for-waf##owasp-v3x)and score threshold combinations in the new OWASP ruleset:
