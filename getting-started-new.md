...
1. [Explore the CIS console](/docs/cis?topic=cis-manage-your-cis-deployment) to familiarize yourself with the areas for domain management, DNS configuration, traffic analytics, and security settings.
