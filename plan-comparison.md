...
|**Custom certificate** \n (For all plans, only one legacy custom certificate that does not support server name indication (non-SNI) can be uploaded.)|1 uploaded custom certificate per domain|25 included custom certificates  \n \n More certificates can be added at a monthly rate|25 included custom certificates  \n \n More certificates can be added at a monthly rate|25 included custom certificates  \n \n More certificates can be added at a monthly rate|1 uploaded custom certificate per domain|
