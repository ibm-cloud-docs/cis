...
|**Custom certificate** \n (For all plans, you can upload only one legacy custom certificate that does not support server name indication (non-SNI).)|1 uploaded custom certificate per domain|25 included custom certificates  \n \n More certificates can be added at a monthly rate|25 included custom certificates  \n \n More certificates can be added at a monthly rate|25 included custom certificates  \n \n More certificates can be added at a monthly rate|1 uploaded custom certificate per domain|
