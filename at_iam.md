...
{: caption="Table 1. Overview" caption-side="top"} 
...
{: caption="Table 2. DNS Domains" caption-side="top"} 
...
{: caption="Table 3. DNS Records" caption-side="top"} 
...
{: caption="Table 4. GLB" caption-side="top"} 
...
{: caption="Table 6. WAF" caption-side="top"} 
...
{: caption="Table 7. IP Firewall" caption-side="top"} 
...
{: caption="Table 8. Firewall Rules" caption-side="top"} 
...
{: caption="Table 9. Security Events" caption-side="top"} 
...
{: caption="Table 10. Rate Limiting" caption-side="top"} 
...
{: caption="Table 11. Caching" caption-side="top"} 
...
{: caption="Table 12. Routing" caption-side="top"} 
...
{: caption="Table 13. Page Rules" caption-side="top"} 
...
{: caption="Table 14. TLS" caption-side="top"} 
...
{: caption="Table 15. Edge Functions" caption-side="top"} 
...
{: caption="Table 16. Range" caption-side="top"} 
...
{: caption="Table 17. Logpush" caption-side="top"} 
...
{: caption="Table 18. Custom Pages" caption-side="top"} 
...
{: caption="Table 20. Edge Functions" caption-side="top"} 
