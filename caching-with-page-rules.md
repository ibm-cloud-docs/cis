...
![url redirection](images/url-redirection-example.png "Image describing forwarding rule"){: caption="Figure 1. Forwarding rule" caption-side="bottom}
...
![url matching](images/url-matching-patterns.png "Image describing Always Use HTTPS rule"){: caption="Figure 2. Always Use HTTPS" caption-side="bottom}
...
![url example](images/url-example.png "Image describing caching images folder"){: caption="Figure 3. Cache everything in /images" caption-side="bottom}
