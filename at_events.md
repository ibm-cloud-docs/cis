...
|internet-svcs.domain_lockdown_rules.update|internet-svcs.domain-lockdown-rules.update|Update domain lockdown rule.|
...
|Action (until July 1, 2020)|Action (starting July 1, 2020)|Description|
|---|---|--|  
|internet-svcs.custom_pages.create|internet-svcs.custom-pages.create|Create a custom error page.|
|internet-svcs.custom_pages.update|internet-svcs.custom-pages.update|Update a custom error page.|
...
|Action (until July 1, 2020)|Action (starting July 1, 2020)|Description|
|---|---|--|  
|internet-svcs.cache_level_setting.update|internet-svcs.cache-level-setting.update|Change caching level.|
|internet-svcs.browser_cache_ttl_setting.update|internet-svcs.browser-cache-ttl-setting.update|Change browser cache TTL.|
|internet-svcs.development_mode_setting.update|internet-svcs.development-mode-setting.update|Enable or Disable development mode.|
|internet-svcs.security_level_setting.update|internet-svcs.security-level-setting.update|Change security level.|
|internet-svcs.ssl_setting.update|internet-svcs.ssl-setting.update|Change SSL setting.|
|internet-svcs.tls_1_2_only_setting.update|internet-svcs.tls-1-2-only-setting.update|Enable or Disable TLS 1.2 support.|
|internet-svcs.waf_setting.update|internet-svcs.waf-setting.update|Enable or Disable web application firewall.|
|internet-svcs.cname_flattening_setting.update|internet-svcs.cname-flattening-setting.update|Change CNAME flattening setting.|
|internet-svcs.always_online_setting.update|internet-svcs.always-online-setting.update|Enable or disable serve stale content for the domain.|
|internet-svcs.sort_query_string_for_cache_setting.update|internet-svcs.sort-query-string-for-cache-setting.update|Enable or disable sorting query arguments when querying content in cache.|
|internet-svcs.tls_1_3_setting.update|internet-svcs.tls-1-3-setting.update|Change TLS 1.3 setting.|
|internet-svcs.automatic_https_rewrites_setting.update|internet-svcs.automatic-https-rewrites-setting.update|Enable or disable automatic HTTPS rewrites.
|internet-svcs.opportunistic_encryption_setting.update|internet-svcs.opportunistic-encryption-setting.update|Enable or disable opportunistic encryption.|
|internet-svcs.browser_check_setting.update|internet-svcs.browser-check-setting.update|Enable or disable browser integrity check.|
|internet-svcs.challenge_ttl_setting.update|internet-svcs.challenge-ttl-setting.update|Update challenge TTL.|
|internet-svcs.always_use_https_setting.update|internet-svcs.always-use-https-setting.update|Enable or disable always use HTTPS.|
|internet-svcs.true_client_ip_header_setting.update|internet-svcs.true-client-ip-header-setting.update|Enable or disable True client IP header.|
|internet-svcs.image_size_optimization_setting.update|internet-svcs.image-size-optimization-setting.update|Enable or disable image size optimization.|
|internet-svcs.script_load_optimization_setting.update|internet-svcs.script-load-optimization-setting.update|Enable or disable script load optimization.|
|internet-svcs.image_load_optimization_setting.update|internet-svcs.image-load-optimization-setting.update|Enable or disable image load optimization.|
|internet-svcs.minify_setting.update|internet-svcs.minify-setting.update|Enable or disable minification for HTML, CSS or JavaScript files.|
|internet-svcs.min_tls_version_setting.update|internet-svcs.min-tls-version-setting.update|Change minimum TLS version.|
|internet-svcs.ip_geolocation_setting.update|internet-svcs.ip-geolocation-setting.update|Enable or disable IP geolocation header.|
|internet-svcs.http2_setting.update|internet-svcs.http2-setting.update|Enable or disable HTTP2 for the domain.|
|internet-svcs.max_upload_setting.update|internet-svcs.max-upload-setting.update|Change the amount of data visitors can upload to the website in a single request.|
|internet-svcs.origin_error_page_pass_thru_setting.update|internet-svcs.origin-error-page-pass-thru-setting.update|Enable or disable the proxy of 502 and 504 error pages returned from origin server.|
