...
이 레코드 유형을 추가하려면 올바른 값이 **이름** 및 **값** 필드에 존재해야 합니다. 값 필드는 기본값이 "URL에 위반 보고서 전송"인 **태그** 드롭 다운 필드의 값과 연관성이 있습니다. 기본값 `Automatic`으로 드롭 다운에서 **TTL**을 지정할 수도 있습니다.
...
![DNS 레코드 가져오기 요약](images/dns/import-records-summary.png)
