...
LEFT THE TAGGING FOR SACHIN IN CASE HE WANTS FOR COMMAND REFERENCE.
...
## Creating a custom list and adding items with the API
...
BARBEE SAID TO CHECK WITH KEVIN AS TO WHETHER THIS IS IMPLEMENTED.  MENTIONED THAT HE THOUGHT THIS WAS FOR BULK REDIRECT LISTS, WHICH WE DON'T SUPPORT.
...
## Creating a custom list and adding items with Terraform
{: #create-custom-list-terraform}
{: terraform}

ADD TERRAFORM EXAMPLE PROVIDED BY ARJUN HERE.  AGAIN, ONLY CREATE AND ADD ITEM
