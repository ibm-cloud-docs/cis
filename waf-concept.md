...
CIS WAF provides a way to configure and manage security rules. After you redirect your DNS to CIS, you can begin applying custom rules. You also get detailed reporting that provides insights into blocked threats and the specific rules or rule groups involved.
