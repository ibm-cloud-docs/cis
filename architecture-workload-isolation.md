...
![Architecture image](images/cis-architecture.svg "CIS Architecture overview"){: caption="{{site.data.keyword.cis_short}} Architecture overview" caption-side="bottom"}
...
{: caption="Critical third party dependencies" caption-side="bottom"}
...
{: caption="Other third party dependencies" caption-side="bottom"}
