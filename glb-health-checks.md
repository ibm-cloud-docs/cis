...
* To prevent health checks from failing, and to secure user infrastructure against spoofed checks from bad actors, do the following:
...
1. From the CIS console, go to **Account > Alerts**.
