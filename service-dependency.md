...
# Service dependency map for IBM Cloud Internet Services
...
{: row-headers}
{: caption="IBM Cloud Internet Services - CIS Control Plane service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-internet-svcs-CIS-Control-Plane"}
{: class="comparison-tab-table"}
{: #critical-deps-cis-control-plane}
...
{: tab-group="service-dependency-data-for-internet-svcs-CIS-Control-Plane"}
{: class="comparison-tab-table"}
{: #significant-deps-cis-control-plane}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| IBM Cloud Global Protect VPN| Security compliance | No | control-plane |  Same data center  |
...
| {{site.data.keyword.cos_full}}| Disaster recovery, Security compliance | No | control-plane |  Same data center  |
| Synthetics| Operations | No | control-plane |  Same region  |
{: row-headers}
{: caption="IBM Cloud Internet Services - CIS Control Plane service dependency information - Minimal dependencies" caption-side="top"}
{: tab-title="Minimal dependencies"}
{: tab-group="service-dependency-data-for-internet-svcs-CIS-Control-Plane"}
{: class="comparison-tab-table"}
{: #minimal-deps-cis-control-plane}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

## The CIS control plane is managed by IBM, while the data plane is managed by Cloudflare.
{: #the-cis-control-plane-is-managed-by-ibm,-while-the-data-plane-is-managed-by-cloudflare.}
