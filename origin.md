...
To get an origin certificate with the API, see [Get an existing origin certificate](/docs/apis/cis#list-origin-certificates).
{: tip}
...
To revoke an origin certificate with the API, see [Revoke a created origin certificate](/docs/apis/cis#revoke-origin-certificate).
