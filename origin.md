...
The private key will only be available immediately after ordering a certificate if the private key and CSR were generated by CIS.
...
1. Order a CIS Origin Certificate using your CSR.
